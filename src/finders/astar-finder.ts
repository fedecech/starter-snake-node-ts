...
export class AStarFinder {
	...
	constructor(params: IAStarFinderConstructor) {
		// Create grid
		this.grid = new Grid({
			width: params.grid.width,
			height: params.grid.height,
			matrix: params.grid.matrix,
		});
		...
		this.diagonalAllowed =
			params.diagonalAllowed !== undefined ? params.diagonalAllowed : true;

		// Set heuristic function
		this.heuristic = params.heuristic ? params.heuristic : 'Manhatten';

		// Set if start node included
		this.includeStartNode =
			params.includeStartNode !== undefined ? params.includeStartNode : true;

		// Set if end node included
		this.includeEndNode =
			params.includeEndNode !== undefined ? params.includeEndNode : true;
	 ...
	 * @param newHeuristic
	 */
	public setHeuristic(newHeuristic: HeuristicFN): void {
